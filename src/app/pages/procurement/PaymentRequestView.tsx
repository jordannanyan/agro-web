...
import { ArrowLeft, CreditCard, Banknote, Copy, Check, Landmark, ShieldAlert, FileSpreadsheet } from "lucide-react";
...
export default function PaymentRequestView() {
  ...
  //
  // It has to stay reachable: reconciliation settles only the lines whose code and
  // amount agree, and nothing can match a stored line by hand afterwards. A transfer
  // whose remark lost the code would otherwise strand its request as Approved for
  // good. Until manual matching exists, this panel is the only way out.
